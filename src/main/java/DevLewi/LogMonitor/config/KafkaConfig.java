...
public class KafkaConfig {
    ...
    // Bulk consumer factory for handling bulk log processing
    @Bean
    public ConsumerFactory<String, Object> bulkConsumerFactory() {
        ...
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
        props.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, false);
        props.put(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, 500); // Higher for bulk processing
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> bulkKafkaListenerContainerFactory() {
        ...
        factory.setConcurrency(2); // Lower concurrency for bulk processing
        factory.getContainerProperties().setAckMode(ContainerProperties.AckMode.MANUAL_IMMEDIATE);
        return factory;
    }
}